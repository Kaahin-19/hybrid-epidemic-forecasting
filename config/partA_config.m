...
%            PARTA_02_RUN_FORECASTS, PARTA_03_EVALUATE.
    ...
    cfg.scenarios(3).class     = "trend";
    cfg.scenarios(3).name      = "Fatigue";
    cfg.scenarios(3).generator = @rt_trend;
    ...
    cfg.scenarios(4).name      = "Resurgence";
    ...
    cfg.forecast.ar_order   = 7;    % AR model lags [days]
