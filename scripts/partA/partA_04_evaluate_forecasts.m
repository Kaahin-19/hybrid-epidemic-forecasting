...
%       3. Compute WIS, RMSE, coverage, and interval-width scores.
...
%LOCAL_EVALUATE_WINDOW Compute all score rows for one forecast window.
    ...
    window_row = table( ...
        ...
        window_rmse, mean_coverage, mean_interval_width, is_valid, ...
        ...
        'WindowWIS', 'WindowRMSE', 'MeanCoverage', 'MeanIntervalWidth', ...
        'IsValid', 'IntervalMethod', 'IntervalStatus', 'RecordedStatus', 'AICC'});
    ...
    pointwise_rows = table( ...
        ...
        'Error', 'SquaredError', 'AbsoluteError', 'WIS', 'CoverageMean', ...
        'IntervalWidthMean', 'IntervalMethod', 'IntervalStatus'});
    ...
    interval_rows = local_interval_rows(window_entry, scenario_id, scenario_name, ...
        ...
        forecast_day, truth_Rt, alphas, lower_Rt, upper_Rt, coverage, interval_width);
end
...
%LOCAL_EMPTY_WINDOW_SCORES Create an empty per-window table.
    table_data = table(strings(0, 1), strings(0, 1), strings(0, 1), ...
        ...
        false(0, 1), strings(0, 1), strings(0, 1), strings(0, 1), zeros(0, 1), ...
        'VariableNames', {'Scenario', 'ScenarioName', 'Model', 'ExoMode', ...
        'ForecastArtifact', 'ResultSource', 'WindowDay', 'WindowDayIdx', ...
        'WindowWIS', 'WindowRMSE', 'MeanCoverage', 'MeanIntervalWidth', ...
        'IsValid', 'IntervalMethod', 'IntervalStatus', 'RecordedStatus', 'AICC'});
