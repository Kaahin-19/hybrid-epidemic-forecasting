...
model_order = ["AR / None", "ARX / I"];
strategy_order = ["Part A online", "Local online", "Part A fixed"];
x_categories = categorical(model_labels, model_order, 'Ordinal', true);
group_categories = categorical( ...
    strategy_labels, strategy_order, 'Ordinal', true);
