...
%       for closed-loop forecasting, where the model structure is fixed and
%       only the current state and effective Rt change at each horizon step.
%
%   Inputs:
%       model_params - Structure with gamma, xi, and pop_size.
%       sim_options  - Structure with solver, seed, and compile fields.
%
%   Outputs:
