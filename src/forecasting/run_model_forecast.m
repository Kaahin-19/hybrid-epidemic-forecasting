...
%       interval bootstrapping is intentionally disabled, the analytic
%       dispatcher is used:
...
% Modified: 2026-06-05
    ...
    use_intervals = forecast_options.intervals.enabled;
...
%% Local Functions
function meta = local_analytic_meta()
%LOCAL_ANALYTIC_META Metadata for the analytic dispatcher path.
    meta = struct();
    meta.interval_method = "analytic_dispatcher_intervals";
    meta.interval_num_draws = 0;
    meta.interval_seed = 0;
    meta.interval_status = "analytic_dispatcher_intervals";
end

function [Rt_pred, aicc, out_alphas, Rt_lower, Rt_upper] = local_analytic_forecast( ...
    model_type, params, Rt_past, U_past, sirs_state, sirs_cfg, exo_mode, ...
    sim_seed, num_exo, horizon, wis_alphas)
%LOCAL_ANALYTIC_FORECAST Analytic forecast dispatch matching model-selection logic.
    switch model_type
        case "AR"
