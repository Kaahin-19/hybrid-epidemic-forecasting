...
%   the family entry before quantile reduction. This protects against unstable
%   identified state-space simulations (notably SSEST) whose free innovation
%   propagation can diverge over the horizon.
    log_lo = log(1e-2);
    log_hi = log(1e2);
end
