...
% A. M. Kaahin 2026-06-22
    ...
    interval_score = interval_width + (2 ./ alphas.') .* underprediction ...
        + (2 ./ alphas.') .* overprediction;
    ...
    wis_interval_component        = wis_sharpness_component ...
        + wis_underprediction_component + wis_overprediction_component;
    ...
    interval = struct( ...
        ...
        'wis_sharpness_component',       wis_sharpness_component, ...
        'wis_underprediction_component', wis_underprediction_component, ...
        'wis_overprediction_component',  wis_overprediction_component, ...
        'wis_interval_component',        wis_interval_component, ...
        'coverage_mean',                 coverage_mean, ...
        'calibration_bias_mean',         calibration_bias_mean, ...
        'absolute_calibration_mean',     absolute_calibration_mean, ...
